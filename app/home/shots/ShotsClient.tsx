      ...
      <div className="bg-plum text-cream px-8 md:px-16 pt-12 pb-12">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-cream/60 text-base mt-3 max-w-xl">
            We have built your family group shots from your Your Circle. Work through each suggestion and tell us which ones you want. The more you include, the more time we will need, so choose the ones that genuinely matter.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-8 md:px-16 py-16 space-y-16">
        ...
        {!familyInCircle && (
          <div className="border border-mauve/40 bg-blush-soft px-8 py-8">
            ...
            <p className="text-base font-light text-ink mb-2">Your Your Circle doesn't have any family members yet.</p>
            <p className="text-sm text-charcoal/70 leading-relaxed mb-5">
              To build your family shot list, we need to know who is coming. Add parents, siblings, step-parents, grandparents, nieces and nephews into Your Circle first. The more detail you add, the more accurate your shot list will be.
            </p>
            <Link
              href="/home/people"
        ...
        {pending.length > 0 && (
          <div>
            ...
            <p className="text-sm text-whisper italic mb-8">
              Based on the people in Your Circle. Include the ones you want and skip the rest. Remember to ask your parents if there are any they would love themselves — this is a family day too.
            </p>
        ...
        <div className="border border-hairline px-8 py-8">
          ...
          <p className="text-sm text-charcoal/70 leading-relaxed mb-4">
            If either of you has extended family you would love to include — a photo of your mum with her sisters, or a big cousins shot — add them into Your Circle and they will appear in your suggestions. Just know that every extra group takes time, so be selective.
          </p>
          <Link
            href="/home/people"
          ...
          >
            Add extended family to Your Circle
          </Link>
        </div>
